export default function AboutMetricCard({score, title, desc}) {
  return (
    <div className="bg-bg-card border border-border rounded-2xl p-6 md:p-8 hover:bg-bg-card-hover hover:border-accent/30 hover:-translate-y-1.5 transition-all duration-300">
